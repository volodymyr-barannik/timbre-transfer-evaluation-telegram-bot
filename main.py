...
from questions.questions import ask_question, load_next_audio_example, go_to_next_question, \
...
def button(update: Update, context: CallbackContext) -> None:
    ...
    if query.data == 'go':
        ...
        selected_audio_examples = [ds.get_random_batch(M_REPRESENTATIVES_FROM_EACH_DATASET) for ds in EVAL_AUDIO_DATASETS]

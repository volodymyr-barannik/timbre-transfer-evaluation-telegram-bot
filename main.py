...
from questions import ask_question, ExampleQuestionsStates, go_to_next_audio_example, go_to_next_question, \
    delete_n_messages_to_be_deleted
...
def start(update: Update, context: CallbackContext) -> None:
    ...
    context.chat_data['message_to_be_deleted'] = []
    ...
    message = update.message.reply_text(f'Hello. I\'ll ask you {N} questions.\n'
                              ...
                              f'\n\nYour marks will make the neural networks better. Ready?', reply_markup=reply_markup)
...
def button(update: Update, context: CallbackContext) -> None:
    ...
    if query.data == 'go':
        ...
        context.user_data['questionNumber'] = 0
